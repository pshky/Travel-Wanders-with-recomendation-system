						...
						if(empty($_SESSION["user_id"]))
						...
						else
							{
                                      ...
                                      echo  '<li class="nav-item"><a href="review.php" class="nav-link active">Review</a> </li>';
										echo  '<li class="nav-item"><a href="your_bookings.php" class="nav-link active">My Location</a> </li>';
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="packages.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite package</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Book and Pay</a></li>
                        
                    </ul>
                </div>
            </div>
			<?php $ress= mysqli_query($db,"select * from locations where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/nepal.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
...
?>								  
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              PACKAGES <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
						...
						<?php  
									$stmt = $db->prepare("select * from packages where rs_id='$_GET[res_id]'");
									$stmt->execute();
                    ...
                    <div class="food-item white">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div class="rest-descr">
                                    <h6><a href="#">Kathmandu Package</a></h6> </div>
               
                            </div>
           
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rs 9999</span></div>
