...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Location</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_location.php">All Locations</a></li>
								<li><a href="add_category.php">Add Category</a></li>
                                <li><a href="add_location.php">Add Location</a></li>
                                
                            </ul>
                        </li>
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Package</span></a>
                            <ul aria-expanded="false" class="collapse">
						 ...
						 <li> <a href="all_booking.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>Booking</span></a></li>
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">View Booking</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											$sql="SELECT users.*, users_orders.* FROM users INNER JOIN users_booking ON users.u_id=users_orders.u_id where o_id='".$_GET['user_upd']."'";
											...
											<tr>
													...
													<?php 
																			...
																			{
																			?>
																			<td> <center><button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Booking</button></center></td>
																		   <?php 
																			  }
																			   if($status=="in process")
																			 { ?>
																			<td>   <center><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span>Processing</button></center></td> 
																			<?php
																				}
																			if($status=="booked")
																				{
																			?>
																			<td>  <center><button type="button" class="btn btn-primary" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Booked</button></center></td> 
																			<?php 
																			} 
																			?>
																			<?php
            ...
            <footer class="footer"> © 2022 - Travel Wanders </footer>
