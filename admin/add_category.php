...
if(isset($_POST['submit'] ))
{
	...
	$check_cat= mysqli_query($db, "SELECT c_name FROM loc_category where c_name = '".$_POST['c_name']."' ");
	...
	$mql = "INSERT INTO loc_category(c_name) VALUES('".$_POST['c_name']."')";
	mysqli_query($db, $mql);
					 ...
					 <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Location Category</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT * FROM loc_category order by c_id desc";
