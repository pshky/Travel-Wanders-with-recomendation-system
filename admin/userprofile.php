...
$sql=mysqli_query($db,"update users_booking set status='$status' where o_id='$form_id'");
...
$ret1=mysqli_query($db,"select * FROM users_booking where o_id='".$_GET['newform_id']."'");
