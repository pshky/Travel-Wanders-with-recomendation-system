...
<body class="home">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
						...
						else
							{
									...
									echo  '<li class="nav-item"><a href="your_bookings.php" class="nav-link active">My Booking</a> </li>';
        ...
        <section class="hero bg-image" data-image-src="images/nepal.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Travel Wanders </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Destination</h4> </div>
                
                        <div class="step-item step2">
                        <img src='images/package.png' style='width: 54px;'/>
                            ...
                            <h4><span style="color:white;">2. </span>Select Package</h4> </div>
                        ...
                        <img src='images/tick.png'/>
                            ...
                            <h4><span style="color:white;">3. </span>Visit Nepal</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Packages of the Month</h2>
                    <p class="lead">Easiest way to Visit Nepal</p>
                </div>
                <div class="row">
						<?php 					
						$query_res= mysqli_query($db,"select * from packages LIMIT 6"); 
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5><a href="packages.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name">'.$r['slogan'].'</div>
                                                    <div class="price-btn-block"> <span class="price">Rs'.$r['price'].'</span> <a href="packages.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Book Now</a> </div>
                                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Featured Destination</h4> </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="restaurants-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
									...
									<?php 
									$res= mysqli_query($db,"select * from loc_category");
                ...
                <div class="row">
                    <div class="restaurant-listing">
						...
						<?php  
						$ress= mysqli_query($db,"select * from locations");  
									      while($rows=mysqli_fetch_array($ress))
										  {
													
													$query= mysqli_query($db,"select * from loc_category where c_id='".$rows['c_id']."' ");
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Our Top Trending Destination</h2>
                </div>
                <div class="row">
						<?php 			
						...
						$query_res= mysqli_query($db,"select * from final_popular ORDER BY avg_rating DESC LIMIT 10"); 
                                while($r=mysqli_fetch_array($query_res))
                                {
                                        
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" data-image-src="'.$r['image_url'].'"></div>
                                                <div class="content">
                                                    <h5><a href="packages.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
