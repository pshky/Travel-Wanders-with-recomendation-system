						...
						if(empty($_SESSION["user_id"]))
						...
						else
							{
                                ...
                                echo  '<li class="nav-item"><a href="review.php" class="nav-link active">Review</a> </li>';
										echo  '<li class="nav-item"><a href="your_bookings.php" class="nav-link active">My Bookings</a> </li>';
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="#">Choose Location</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a href="#">Pick Your favorite packages</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Visit!!!</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-9">
                            <div class="bg-gray restaurant-entry">
                                <div class="row">
								<?php $ress= mysqli_query($db,"select * from locations");
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
																		...
																		<a href="packages.php?res_id='.$rows['rs_id'].'" class="btn btn-purple">View Packages</a> </div>
																</div>
																<!-- end:right info -->
															</div>';
										  }
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5>Phone: 9872659495</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Join to benefit from being partnered with us.</p>
                                </div>
                    </div>
                </div>
